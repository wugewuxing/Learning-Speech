...
def ConvAttRNNModel(nCategories, samplingrate = 16000, inputLength = 16000):
    """
    Using Convolution + Attention + RNN Neural Networks
    """ 
    ...
    #x = Conv2D(10,(5,1),padding = 'same', activation = 'relu')(x)
    #x = BatchNormalization()(x)
    #x = Conv2D(1,(3*3),Activation = 'relu',padding = 'same')(x)
    #x = BatchNormalization()(x)
    x_First = Conv2D(10,(3,3),Activation = 'relu', padding = 'same')(x)
    x_First = BatchNormalization()(x_First)
    x_First = Conv2D(1,(3,3),Activation = 'relu',padding = 'same'(x_First))
    x_First = BatchNormalization()(x_First)   
    ...
    x_First = Lambda(lambda q: K.squeeze(q, -1), name='squeeze_last_dim') (x_First)
    x_First = Lambda(lambda q: q[:,64]) (x) #[b_s, vec_dim]
